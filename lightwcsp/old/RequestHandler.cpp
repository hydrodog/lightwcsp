...
bool RequestHandler::isBlank(const char currentChar) {
...
int RequestHandler::getBodyLength() {
	return bodyLength;
}
...
const char * RequestHandler::getVersion() {
	return httpVersion;
}

const char * RequestHandler::getHost() {
	return host;
}
